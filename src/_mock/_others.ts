...
export const CONSIGNATARIA = [
  { code: '037', label: 'BANCO DO ESTADO DO PARA S A' },
  { code: '104', label: 'CAIXA ECONOMICA FEDERAL' },
  { code: '001', label: 'BANCO DO BRASIL S A' },
  { code: '033', label: 'BANCO SANTANDER (BRASIL) S A' },
  { code: '237', label: 'BANCO BRADESCO S A' },
  { code: '341', label: 'BANCO ITAU S A' },
  { code: '745', label: 'BANCO CITIBANK S A' },
  { code: '399', label: 'HSBC BANK BRASIL S A BANCO MULTIPLO' },
  { code: '356', label: 'BANCO ABN AMRO REAL S A' },
  { code: '652', label: 'ITAÚ UNIBANCO BM S.A.' },
  { code: '422', label: 'BANCO SAFRA S A' },
  { code: '633', label: 'BANCO RENDIMENTO S A' },
  { code: '041', label: 'BANCO DO ESTADO DO RIO GRANDE DO SUL S A' },
  { code: '748', label: 'BANCO COOPERATIVO SICREDI S A' },
  { code: '756', label: 'BANCO COOPERATIVO DO BRASIL S A - BANCOOB' },
  { code: '004', label: 'BANCO DO NORDESTE DO BRASIL S A' },
  { code: '047', label: 'BANCO DO ESTADO DE SERGIPE S A' },
  { code: '070', label: 'BRB - BANCO DE BRASILIA S A' },
  { code: '104', label: 'CAIXA ECONOMICA FEDERAL' },
  { code: '107', label: 'BANCO BBM S A' },
  { code: '151', label: 'CAIXA ECONOMICA ESTADUAL' },
  { code: '175', label: 'BANCO FINASA S A' },
  { code: '184', label: 'BANCO ITABANK S A' },
];

export const CONSIGNACAO = [
  { code: '184', label: 'PARC. CONSIG. BANPARA - (EMPRÉSTIMO CONSIGNADO)', consignataria: '037' },
  { code: '189', label: 'PARC. CONSIG. BANPARA - (EMPRÉSTIMO CONSIGNADO)', consignataria: '037' },
  { code: '262', label: 'PARC. CONSIG. BANPARA I - (EMPRÉSTIMO CONSIGNADO)', consignataria: '037' },
  {
    code: '280',
    label: 'PARC. CONSIG. BANPARA II - (EMPRÉSTIMO CONSIGNADO)',
    consignataria: '037',
  },
];
